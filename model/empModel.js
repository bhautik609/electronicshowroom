...
console.log(data);
        return db.query('insert into emp_tbl values(?,?,?,?,?,?)',[null,data.emp_name,data.emp_email,data.emp_salary,data.emp_join_date,data.emp_deg,data.emp_id],callback);
    },
    ...
    editemp:function(data,callback){
        return db.query('update emp_tbl set emp_name=?,emp_email=?,emp_salary=?,emp_join_date=?,emp_deg=? where emp_id=?',[data.emp_name,data.emp_email,data.emp_salary,data.emp_join_date,data.emp_deg,data.emp_id],callback); 
    }
