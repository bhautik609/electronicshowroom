...
var orderdetail={
    ...
    addorderdetail:function(data,callback){
        ...
        return db.query('insert into order_detail values(?,?,?,?)',[null,data.order_id_fk,data.product_id_fk,data.order_qut],callback);
    },
    ...
    getorderdetailbyId:function(id,callback){
        //console.log(id);
        return db.query('select * from order_detail where order_deatil_id=?',[id],callback);
    },
