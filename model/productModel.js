...
var product={
    ...
    addproduct:function(data,callback){
        ...
        return db.query('insert into product_tbl values(?,?,?,?,?,?,?,?,?,?,?,?)',[null,data.product_name,data.product_color,data.product_mfd,data.product_price,data.product_warr,data.product_garr,data.product_desc,data.product_img1,data.product_img2,data.product_img3,data.cat_id_fk],callback);
    },
