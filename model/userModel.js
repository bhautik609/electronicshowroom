...
var user={
    ...
    edituser:function(data,callback){
        return db.query('update user_tbl set user_name=?,user_password=?,user_email=?,user_age=?,user_gender=?,user_mob=?,user_address=? where user_id=?',[data.user_name,data.user_password,data.user_email,data.user_age,data.user_gender,data.user_mob,data.user_address,data.user_id],callback); 
    }
